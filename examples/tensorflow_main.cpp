...
// CMAKE UPDATE
// message(HELLO "${TensorFlow_LIBRARY_DIRS}" INFO)
// link_directories(${TensorFlow_LIBRARY_DIRS})
// include_directories(${TensorFlow_INCLUDE_DIRS})
// add_compile_definitions(${TensorFlow_CFLAGS_OTHER})
// add_executable(tensorflow_main ${HOMING_PIGEON_ROOT}/examples/tensorflow_main.cpp)
// target_link_libraries(tensorflow_main ${TensorFlow_LIBRARIES})
// target_include_directories(tensorflow_main PUBLIC ${TensorFlow_INCLUDE_DIRS})
