...
// Various stdlib support checks that checks __has_include
...
// Constructor and destructor api
...
#else
            CATCH_ERROR( "Test failure checks aborting test!" );
#endif
        }
    }
...
#if defined(__clang__)
#  pragma clang diagnostic push
// For simplicity, benchmarking-only api are always enabled
#  pragma clang diagnostic ignored "-Wunused-function"
#endif
